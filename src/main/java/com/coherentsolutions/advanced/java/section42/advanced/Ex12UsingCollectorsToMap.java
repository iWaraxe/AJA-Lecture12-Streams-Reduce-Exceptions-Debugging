 ...
 * Collectors.toMap() is optimized for mapping operations and provides better performance
 * compared to manually accumulating entries using reduce().
 */
public class Ex12UsingCollectorsToMap {
